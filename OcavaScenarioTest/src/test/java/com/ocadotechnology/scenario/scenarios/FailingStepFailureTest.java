...
@Story
class FailingStepFailureTest extends AbstractFrameworkTestStory {
    ...
    public void executeTestSteps() {
        AssertionError e = Assertions.assertThrows(
                ...
                "No error thrown");
        Assertions.assertEquals("Failing step defined but test does not have @FixRequired ==> expected: <true> but was: <false>", e.getMessage());
    }
