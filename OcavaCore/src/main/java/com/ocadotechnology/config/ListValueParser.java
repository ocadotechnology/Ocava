...
public class ListValueParser {
    ...
    public ListValueParser(String value) {
        this.value = value;
    }
    ...
    /**
     * @return an {@link ImmutableList} containing the String config value parsed as a comma (",") or colon (":")
     *          separated list, with each element converted to a double via {@link Double#parseDouble(String)}.
    ...
    /**
     * @return an {@link ImmutableList} containing the String config value parsed as a comma (",") or colon (":")
     *          separated list, with each element  parsed to an enum value via {@link Enum#valueOf(Class, String)}.
    ...
    /**
     * @return an {@link ImmutableList} containing the String config value parsed as a comma (",") or colon (":")
     *          separated list, with each element converted to a long then wrapped in an {@link Id}.
     * @throws NumberFormatException if any elements cannot be parsed to longs.
     */
    ...
    /**
     * @return an {@link ImmutableList} containing the String config value parsed as a comma (",") or colon (":")
     *          separated list, with each element wrapped in a {@link StringId}.
     */
    ...
    /**
     * @return an {@link ImmutableList} containing the String config value parsed as a comma (",") or colon (":")
     *          separated list, with each element converted using the supplied function.
     */
